...
def mendel(k,m,n):
    """
    takes in number of organisms having certain alleles (dominant or recessive) and outputs
    the probability of those phenotypically presenting as dominant
    :param k: homozygous dominant
    :param m: heterozygous dominant
    :param n: homozygous recessive
    :return: probability of dominance
    """
    pop = k + m + n
